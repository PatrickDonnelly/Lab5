...
public:
	...
	MyVector3(sf::Vector3f t_sfVector); // floats
	MyVector3(sf::Vector3i t_sfVector); // ints
	MyVector3(sf::Vector2i t_sfVector); // ints
	MyVector3(sf::Vector2u t_sfVector); // unsigned ints
	MyVector3(sf::Vector2f t_sfVector); // float
